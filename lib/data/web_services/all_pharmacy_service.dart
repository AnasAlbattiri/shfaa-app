...
class AllPharmacyService {
  static Future<List<PharmacyModel>> fetchAllPharmacy(int patientId, activeFlag) async {
    // URL of the API endpoint
    var url = Uri.parse(
        'http://${AppConstants.serverIP}/SIQMobileAPI/resources/model/queryPresecPhrOrderFindByPatientId?patientId=$patientId&lang&activeFlag=$activeFlag');
